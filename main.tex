...
\begin{definition}
     We define the above process as \emph{comparing of coefficients (COC)} and this thesis is designated to evaluate the stability of the constrants $p(x) = \langle Q, \mathbf{bb}^T \rangle$.
\end{definition}
