...
\begin{figure*}[hbt!]
     ...
     {\small Condition number of the coefficient moment matrix for same basis (Univariate)}% 
 \end{figure*}
...
\begin{figure*}[hbt!]
     ...
     {\small Monomial with Orthogonal Polynomials (Univariate)}% 
 \end{figure*}
...
Again, the condition number is smaller when the basis of the polynomials and the basis of the moment matrix is the same. 
\begin{figure*}[hbt!]
     \centering
     \begin{subfigure}[b]{0.475\textwidth}
         \centering
     ...
     \end{subfigure}
     \caption[ Condition number of the coefficient moment matrix for same basis]%
     {\small Condition number of the coefficient moment matrix for same basis}% 
 \end{figure*}
